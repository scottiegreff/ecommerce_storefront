      ...
      <Container>
        <div className="px-4 py-10 sm:px-6 lg:px-8 rounded-2xl">
          <div
            ...
            className="relative aspect-square md:aspect-[2.35/1] overflow-hidden bg-cover border border-[#C68DBA] rounded"
          >
            <div className="h-full w-full flex flex-col justify-center items-center text-center gap-y-8">
              <div className="font-bold text-[#C68DBA] drop-shadow-2xl  text-3xl sm:text-5xl lg:text-7xl sm:max-w-xl max-w-xs">
                {service.name}
              </div>
            </div>
          </div>
